public class Main {
    public static void main(String args[]){
        ...
        */
        ...
        System.out.println((10 * 0.8509 + 2) - Math.pow(Math.sqrt(25), 3));
        System.out.println((10 * 0.8509 + 2) - Math.pow(5.0,3));
        System.out.println((8.509 + 2) - Math.pow(5,3))
        System.out.println((8.509 + 2) - 125.0)
        System.out.println(10.509 - 125.0)
        System.out.println(-114.491)

        Not sure if I should round the Math.sin(45) so I rounded to 4 decimal places otherwise the value would be
        System.out.println(10 * Math.sin(45) - 125)
        System.out.println(-114.49096475465882)
        *the value above was the systems output
        */
    }
}
